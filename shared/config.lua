...
Config.Prefix = "char"
Config.Locale = 'dk'
Config.Cam = vec4(-1180.1158, -1893.6410, 972.2230, 13.4359)
...
Config.ClothingMenu = 'pure-clothing' -- ['fivem-appearance', 'illenium-appearance', 'rcore-clothing', 'pure-clothing'] | To add more line - [179 - client/main.lua]
